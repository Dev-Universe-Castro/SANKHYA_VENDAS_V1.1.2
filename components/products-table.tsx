...
import { Search, ChevronLeft, ChevronRight, Package, Eye, ChevronDown, ChevronUp, WifiOff } from "lucide-react"
...
export default function ProductsTable() {
  ...
  useEffect(() => {
    // Só aplica filtros se houver produtos carregados e a página mudar
        ...
        <DialogContent className="max-w-md">
          ...
          {produtoSelecionado && (
            <div className="space-y-4">
              <div>
                <h3 className="font-semibold text-lg">{produtoSelecionado.CODPROD} - {produtoSelecionado.DESCRPROD}</h3>
              </div>
              ...
              <div className="space-y-2">
                <Label htmlFor="tabela-preco" className="text-sm text-muted-foreground">Tabela de Preço</Label>
                <Select
              ...
              <Button onClick={() => setEstoqueModalOpen(false)} className="w-full bg-green-600 hover:bg-green-700">
                Fechar
              </Button>
            </div>
          )}
